...
function S2() {
    ...
    if (!USERNAME || !SELECTED_PLATFORM) {
        ...
        alert("Enter your NBA username and select your platform.")
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        ...
                        $("#FINAL_IMG").attr("src", "https://d13pxqgp3ixdbh.cloudfront.net/uploads/16530415114bfa24ee2e6e05c0b3650001273868bd.png");
                        ...
                        setTimeout(function () {
                            ...
                            setTimeout(function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    $("#CTEXT").removeClass("animate__" + TRANSITION1 + "Out").html("Adding VC!")
...
function S3() {
    ...
    if (!SELECTED_VB) {
        ...
        alert("Select how much VC you want!");
...
function LAST() {
    ...
    $("#TEXTEND").text(USERNAME + ", you are almost finished! To finish transfering " + SELECTED_VB + " VC to your account click the Verify button below and follow instructions.")
